...
public class PlayerController : MonoBehaviour
{
    ...
    //Movement
    [Header("Movement")]
    [Tooltip("How fast the player goin'")] public float moveSpeed = 4500;
    [Tooltip("Maximum speed of player!")] public float maxSpeed = 20;
    [Tooltip("What is Ground?")] public LayerMask whatIsGround;

    [Tooltip("Some drag or something that the player isnt that fast!")] public float counterMovement = 0.175f;
    ...
    [Header("Sliding")]
    [Tooltip("How much force you get on a slide!")] public float slideForce = 400;
    [Tooltip("Some drag or something that the slide isnt that fast!")] public float slideCounterMovement = 0.2f;
